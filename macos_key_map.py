...
def macos_key_map(ui: Ui_MainWindowK2):
    return {
        ...
        "f13": {
            "vk": {"win": 0x7C, "mac": 0x69},
            "widget": ui.key_f13,
        },
        "f14": {
            "vk": {"win": 0x7D, "mac": 0x6B},
            "widget": ui.key_f14,
        },
        "f15": {
            "vk": {"win": 0x7E, "mac": 0x71},
            "widget": ui.key_f15,
        },
        "f16": {
            "vk": {"win": 0x7F, "mac": 0x6A},
            "widget": ui.key_f16,
        },
        "f17": {
            "vk": {"win": 0x80, "mac": 0x40},
            "widget": ui.key_f17,
        },
        "f18": {
            "vk": {"win": 0x81, "mac": 0x4F},
            "widget": ui.key_f18,
        },
        ...
        "ctrl": {
            "vk": {"win": 0x11, "mac": 0x3B},  # Left Control
            "widget": ui.key_Control,
        },
        "ctrl2": {
            "vk": {"win": 0xE01D, "mac": 0x3E},  # Right Control
            "widget": ui.key_Control_2,
        },
        "win": {
            "vk": {"win": 0x5B, "mac": 0x37},  # Left Command
            "widget": ui.key_Command,
        },
        "win2": {
            "vk": {"win": 0x5C, "mac": 0x36},  # Right Command
            "widget": ui.key_Command_2,
        },
        "alt": {
            "vk": {"win": 0x12, "mac": 0x3A},  # Left Option
            "widget": ui.key_Option,
        },
        "alt2": {
            "vk": {"win": 0xE038, "mac": 0x3D},  # Right Option
            "widget": ui.key_Option_2,
        },
        "space": {
